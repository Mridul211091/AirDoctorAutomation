...
public class ADSiteMergeOrderFlowTest extends BaseTest {
	...
	public void affilatePageSetup() throws InterruptedException {
	  ...
	  @DataProvider public Object[][] getDataFromExcel() { 
	   return ExcelUtil.getTestData(AppConstants.SITE_MERGE_SHEET_NAME); 
	   }
	...
	try {
	  ...
	  adsitemergepage.placeOrder();
	  Thread.sleep(15000);
	  adsitemergepage.SelectUpsell(Upsell1);
	  Thread.sleep(5000);
	  adsitemergepage.getThankYoPageURL();
	  Map<String, String>  productActDetailsMap = adsitemergepage.getpostorderdetails();
	  ...
	  System.out.println("=============================================================");
	  adsitemergepage.writeexcel(preOrderDetailsMap.get("preordersubtotal"),preOrderDetailsMap.get("preorderShipping"),preOrderDetailsMap.get("preordertax"),preOrderDetailsMap.get("preordertotal"),productActDetailsMap.get("subtotal"),productActDetailsMap.get("Shipping"),productActDetailsMap.get("tax"),productActDetailsMap.get("total"),productActDetailsMap.get("OrderID"),currenttest); 
