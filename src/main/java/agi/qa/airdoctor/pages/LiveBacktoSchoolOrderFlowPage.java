...
public class LiveBacktoSchoolOrderFlowPage {
	...
	private By ad3500_2000_smartproductregularpricetext = By.xpath("//section[contains(@class,'product_section_289211')]//p[contains(@class,'earth_day_price_iot')]//del[contains(@aria-hidden,'true')]//bdi[1]");
	...
	private By checkoutBtn = By.xpath(
			"//button[@class='btn btn-checkout']//span[@id='prc']");
  ...
  @Step("Getting PreSubtotal,PreTax,PreShipping,PreFinal Total from from Checkout Page")
	...
	public void selectModel(String ModelName, String ProductQuantity,String ModeltwoName, String ProducttwoQuantity) throws InterruptedException, Exception {
		try {
			...
			if (ModelName.equalsIgnoreCase("AD3500 with AD2000") && ProductQuantity.equals("1")) {
				System.out.println(ModelName + " with quantity " + ProductQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Allure.addAttachment("Select Model 1", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
				Thread.sleep(5000);
				eleUtil.doActionsClick(ad3500_2000_addToCart);
				Thread.sleep(3000);
				selectSecondModel(ModeltwoName, ProducttwoQuantity);
				eleUtil.doActionsClick(checkoutBtn);
			}
			else if (ModelName.equalsIgnoreCase("AD3500 with AD2000") && ProductQuantity.equals("2")) {

				System.out.println(ModelName + " with quantity " + ProductQuantity);;
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				Allure.addAttachment("Select Model 1", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
				eleUtil.doActionsClick(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				eleUtil.doActionsClick(ad3500_2000_addToCart);
				Thread.sleep(4000);
				selectSecondModel(ModeltwoName, ProducttwoQuantity);
			...
			else if (ModelName.equalsIgnoreCase("AD3500 with AD2000") && ProductQuantity.equals("3")) {
				System.out.println(ModelName + " with quantity " + ProductQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				eleUtil.doActionsClick(ad3500_2000_increasequantitybtn);
			...
			else if (ModelName.equalsIgnoreCase("AD3500i with AD2000i") && ProductQuantity.equals("1")) {
				System.out.println(ModelName + " with quantity " + ProductQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(5000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
				//eleUtil.doActionsClick(ad3500UpgradeToIotCheckbox);
				Thread.sleep(5000);
				Allure.addAttachment("Select Model 1", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
				eleUtil.doActionsClick(ad3500_2000_addToCart);
			...
			else if (ModelName.equalsIgnoreCase("AD3500i with AD2000i") && ProductQuantity.equals("2")) {
				System.out.println(ModelName + " with quantity " + ProductQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(5000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
			...
			else if (ModelName.equalsIgnoreCase("AD3500i with AD2000i") && ProductQuantity.equals("3")) {
				System.out.println(ModelName + " with quantity " + ProductQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
	...
	public void selectSecondModel(String ModeltwoName, String ProducttwoQuantity) throws InterruptedException, Exception {
		try {
			...
			if (ModeltwoName.equalsIgnoreCase("AD3500 with AD2000") && ProducttwoQuantity.equals("1")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(5000);
				Allure.addAttachment("Select Model 2", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
				eleUtil.doActionsClick(ad3500_2000_addToCart);
				Thread.sleep(3000);
				
			}
			else if (ModeltwoName.equalsIgnoreCase("AD3500 with AD2000") && ProducttwoQuantity.equals("2")) {
			...
			else if (ModeltwoName.equalsIgnoreCase("AD3500 with AD2000") && ProducttwoQuantity.equals("3")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				eleUtil.doActionsClick(ad3500_2000_increasequantitybtn);
			...
			else if (ModeltwoName.equalsIgnoreCase("AD3500i with AD2000i") && ProducttwoQuantity.equals("1")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(5000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
			...
			else if (ModeltwoName.equalsIgnoreCase("AD3500i with AD2000i") && ProducttwoQuantity.equals("2")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(5000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
			...
			else if (ModeltwoName.equalsIgnoreCase("AD3500i with AD2000i") && ProducttwoQuantity.equals("3")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(ad3500_2000_increasequantitybtn);
				Thread.sleep(3000);
				eleUtil.doClickcheckbox(ad3500_2000_UpgradeToIotCheckbox, TimeUtil.DEFAULT_LONG_TIME);
			...
			else if (ModeltwoName.equalsIgnoreCase("AD3500")&& ProducttwoQuantity.equals("1")) {
				System.out.println(ModeltwoName + " with quantity " + ProducttwoQuantity);
				eleUtil.scrollTiView(AD3500increasequantitybtn);
				Thread.sleep(5000);
				Allure.addAttachment("Select Model 2", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
