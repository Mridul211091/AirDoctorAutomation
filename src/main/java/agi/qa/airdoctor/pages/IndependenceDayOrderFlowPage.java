...
public class IndependenceDayOrderFlowPage {
	...
	public IndependenceDayOrderFlowPage(WebDriver driver) {
		this.driver = driver;
	...
	public IndependenceDayOrderFlowPage getaffiliateURL(String url) throws InterruptedException {
		driver.get(url);
